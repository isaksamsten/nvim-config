...
vim.keymap.set({ "n", "v" }, "<M-1>", "<Esc><Cmd>tabnext 1<CR>", { desc = "Next tab" })
vim.keymap.set({ "n", "v" }, "<M-2>", "<Esc><Cmd>tabnext 2<CR>", { desc = "Next tab" })
vim.keymap.set({ "n", "v" }, "<M-3>", "<Esc><Cmd>tabnext 3<CR>", { desc = "Next tab" })
vim.keymap.set({ "n", "v" }, "<M-4>", "<Esc><Cmd>tabnext 4<CR>", { desc = "Next tab" })
