return { -- TODO
  ...
  --   end,
  --   keys = {
  --     { "<leader>oe", "<cmd>TroubleToggle document_diagnostics<cr>", desc = "Document diagnostics" },
  --     { "<leader>oE", "<cmd>TroubleToggle workspace_diagnostics<cr>", desc = "Workspace diagnostics" },
